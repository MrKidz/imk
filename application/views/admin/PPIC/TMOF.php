                ...
                <div class="card-header bg-primary" >
                    ...
                    <table border="1" style="align: center;">
                        <tr>
                            ...
                            <td class="theadd"><input type="text" id="KodePack" name="KodePack" placeholder="Kode Pack" class="form-control" ></td>
                        ...
                        <tr>
                            ...
                            <td rowspan="2" class="theadd"><input type="text" id="NamaArtikel" name="NamaArtikel" placeholder="Nama Article" class="form-control"></td>
                        </tr>
                        <tr>
                        </tr>
                        <tr>
                            ...
                            <td class="theadd"><input type="text" id="NamaCustomer" name="NamaCustomer" placeholder="Nama Customer" class="form-control"></td>
                            <td align=center class="wh">NO FI</td>
                            <td><input type="text" id="NoFI" name="NoFI" placeholder="NO FI" class="form-control"></td>
                        </tr>
                        <tr>
                            <td colspan="3"  align=center class="wh"> Acuan Print Out</td>
                        ...
                        <tr>
                            <td rowspan="2" colspan="3"><input type="text" id="AcuanPrintOut" name="AcuanPrintOut" placeholder="ACC" class="form-control">
                            <input type="date" id="TglACP" name="TglACP" class="form-control"> </td>
                        </tr>
                        <tr>
                        </tr>
                        <tr>
